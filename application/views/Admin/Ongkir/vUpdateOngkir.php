	...
	<div class="content-wrapper">
		...
		<div class="row">
			<div class="col-md-6 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url('Admin/cOngkir/update/' . $kecamatan->id_ongkir) ?>" method="POST">

							<div class="form-group">
								<label for="input-2">Nama Kecamatan</label>
								<input type="text" name="nama" value="<?= $kecamatan->nama_kecamatan ?>" class="form-control" />
								<?= form_error('nama', '<small class="form-text text-danger">', '</small>'); ?>
							</div>
							<div class="form-group">
								<label for="input-2">Ongkos Kirim</label>
								<input type="number" value="<?= $kecamatan->ongkir ?>" name="ongkir" class="form-control" />
