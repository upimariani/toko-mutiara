					...
					<div class="card-body px-3 py-4">
						<div class="d-flex justify-content-between align-items-start">
							<div class="color-card">
								<?php
								$total_tdk_laku = $this->db->query("SELECT COUNT(id_analisis) as jml FROM `analisis` WHERE thn_periode='2020' AND status='1'")->row();
								?>
				...
				<div class="card bg-success">
					<div class="card-body px-3 py-4">
						<div class="d-flex justify-content-between align-items-start">
							<div class="color-card">
								<?php
								$total_laku = $this->db->query("SELECT COUNT(id_analisis) as jml FROM `analisis` WHERE thn_periode='2020' AND status='2'")->row();
								?>
